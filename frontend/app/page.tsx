          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                <AnimatedButton className="btn-primary px-6 py-3 text-lg">Start Playing</AnimatedButton>
                <AnimatedButton className="btn-secondary px-6 py-3 text-lg">Watch Demo</AnimatedButton>
              </div>
            </motion.div>
