    ...
    <div className="min-h-screen bg-background">
            ...
            <div className="inline-block mb-4">
              <div className="relative">
                ...
                <div className="relative bg-primary/10 px-6 py-2 rounded-full border border-primary/20">
                  <span className="text-primary font-medium">Interactive Exhibit</span>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 -mt-16 relative z-20">
        {isLoading ? (
          ...
          <motion.div
            ...
            className="max-w-4xl mx-auto mb-24 rounded-3xl overflow-hidden shadow-xl bg-card"
          >
            <div className="relative">
              <Carousel
                showArrows={true}
              ...
              >
                {emotions.map((emotion) => (
                  <div key={emotion.id} className="p-8 md:p-12 text-center">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold mt-4 text-foreground">{emotion.name}</h2>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground">Emotion Gallery</h2>
            <p className="text-muted-foreground mt-2">Explore our collection of emotions</p>
          </div>
          ...
          >
            {emotions.map((emotion, index) => (
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="bg-card rounded-2xl shadow-md overflow-hidden cursor-pointer transition-all duration-300 border border-border"
                onClick={() => handleEmotionClick(emotion.id)}
              >
                ...
                <div className="p-4">
                  <h3 className="text-center font-medium text-foreground">{emotion.name}</h3>
                </div>
              </motion.div>
            ))}
          </motion.div>
      ...
      <div className="bg-muted py-12">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-xl font-semibold mb-4">About Our Emotion Museum</h3>
        ...
        {isModalOpen && selectedEmotionData && (
          ...
          >
            <motion.div
              ...
              className="bg-card max-w-lg w-full rounded-3xl p-6 shadow-2xl border border-border"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex justify-between items-start mb-6">
                <h2 className="text-2xl font-bold text-foreground">{selectedEmotionData.name}</h2>
                <button
                  onClick={closeModal}
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div>
                  <p className="text-muted-foreground mb-6">{selectedEmotionData.description}</p>
